...
# (New-Object System.Net.WebClient).DownloadString("https://raw.githubusercontent.com/Shopify/themekit/new_windows_installer/scripts/install.ps1") | powershell -command -
